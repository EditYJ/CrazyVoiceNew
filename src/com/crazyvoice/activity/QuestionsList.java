...
public class QuestionsList extends Activity {
	...
	public final static String QUESTION = "com.crazyvoice.activity.QUESTION";
						...
						if (rname.equals("")) {
							...
							if (chatRoomMap.containsKey(message)) {
								Toast.makeText(
										...
										"Your question had been asked by other person,"
												+ "you can communicate with him",
										Toast.LENGTH_LONG).show();
								intent.putExtra(ANSWER_QUESTION,
										chatRoomMap.get(message));
